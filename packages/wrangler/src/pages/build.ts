...
export const Handler = async ({
	...
	// for now let's restrict `outfile` to `_worker.bundle` if the
	// experimentalWorkerBundle flag is set. Once we remove the flag
	...
	// `wrangler pages functions build --experimental-worker-bundle=true`
	if (
		!isInPagesCI &&
		experimentalWorkerBundle &&
		!foundWorkerScript &&
